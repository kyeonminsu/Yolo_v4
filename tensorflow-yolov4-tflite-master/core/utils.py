...
def draw_bbox(image, bboxes, classes=read_class_names(cfg.YOLO.CLASSES), show_label=True):
    ...
    for i in range(num_boxes[0]):
        ...
        #https: // stackoverflow.com / questions / 67921192 / tflite - detext - error - cv2 - error - opencv4 - 5 - 2 - 1 - error - 5 bad - argument - in -f
        fontScale = 0.5
       ...
       # cv2.rectangle(image, int(c1), int(c2), bbox_color, bbox_thick)
